...
public class GlobalExceptionHandler {
  ...
  public ResponseEntity<ErrorResponse> handleEntityNotFoundException(NotFoundException e) {
    return ResponseEntity.badRequest().body(new ErrorResponse("E001", e.getMessage()));
  }

  @ExceptionHandler(IllegalStateException.class)
  public ResponseEntity<ErrorResponse> handleIllegalStateException(IllegalStateException e) {
    return ResponseEntity.badRequest().body(new ErrorResponse("E002", e.getMessage()));
  }
  ...
  public ResponseEntity<ErrorResponse> handleValidationExceptions(
    ...
    return ResponseEntity.badRequest().body(new ErrorResponse("E003", errorMessage));
  }

  @ExceptionHandler(Exception.class)
  public ResponseEntity<ErrorResponse> handleAllExceptions(Exception e) {
    log.error("Unexpected error occurred: ", e); // 로깅 추가
    return ResponseEntity.internalServerError().body(new ErrorResponse("E999", e.getMessage()));
  }
