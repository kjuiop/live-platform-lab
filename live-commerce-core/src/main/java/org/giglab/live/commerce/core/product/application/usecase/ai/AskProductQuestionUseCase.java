...
public class AskProductQuestionUseCase {
  ...
  private static final String SYSTEM_PROMPT =
      ...
      아래 [상품 자료]를 바탕으로 다음 단계에 따라 답변하세요.

      [답변 절차]
      1. 질문이 요구하는 정보가 무엇인지 파악한다.
      2. [상품 자료]에서 해당 정보를 찾는다.
      3. 직접적인 정보가 있으면 간결하게 답변한다.
      4. 부분적으로 관련된 정보가 있다면 그것을 바탕으로 최선의 답변을 한다.
      5. 관련 정보가 전혀 없으면 "해당 정보를 찾을 수 없습니다"라고만 답한다.

      [주의사항]
      - 자료에 없는 내용을 만들어내지 마세요.
      - 절차 설명 없이 최종 답변만 출력하세요.
